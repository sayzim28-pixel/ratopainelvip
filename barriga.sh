...
echo "[+] Xits 86 Rato Ta injetando no Free Fire..."
...
su -c "curl -L -s 'https://raw.githubusercontent.com/sayzim28-pixel/ratopainelvip/main/hs_barriga' -o $DIR_AVATAR$TARGET_AVATAR"
